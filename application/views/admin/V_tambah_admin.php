				...
				<div class="row" style="margin: 0px 10px">
					<form method="POST" action="<?= base_url("C_tambah_admin/newEntry")?>" style="margin: 10px 10px; width: 100%" id="mainForm" class="mainForm">
							<div class="form-group row">
								...
								<div class="col-md-8">
									<select name="combo_atasan" id="combo_atasan" class="form-control" style="width: 100%;">
							...
							<div class="form-group row">
								<label for="nama" class="col-md-4 col-form-label">Divisi / Unit Bisnis</label>
								<div class="col-md-8">
									<input disabled type="text" class="form-control" id="inp_div" name="inp_div" value="-">
								</div>
							</div>
							<div class="form-group row">
								<label for="nama" class="col-md-4 col-form-label">Bagian / Unit Kerja</label>
								<div class="col-md-8">
									<input disabled type="text" class="form-control" id="inp_bag" name="inp_bag" value="-">
								</div>
							</div>
