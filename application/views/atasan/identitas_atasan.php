                ...
                <div class="container-fluid">
                    ...
                    <div class="row div_center id_atas" style="margin:auto; margin-top: 25px;">
                        <div class="input-group mb-3">
                            <input placeholder="Nama Lengkap" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                        </div>
                        <div class="input-group mb-3">
                        	<input placeholder="NIK" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                        </div>
                    	<button class="btn btn-info btn-lg" style="display: block; text-align: center; margin: auto;">Next</button> 
                    </div>
