        ...
        <div class="row">
            <div class="col-md-12">              
                <nav class="navbar navbar-dark navbar-expand-sm" style="background-color: #004D8D;">
                    <a href="<?php echo site_url('C_dasboard_atasan'); ?>" class="navbar-brand">
                        <img src="<?= base_url()?>assets/img/logoo.png" alt="Logo" style="width:250px;">
                    </a>                    
                    <ul class="navbar-nav ml-auto">                  
                        <li class="nav-item">
                            <a class="nav-link" style="padding-right: 30px;" href="<?php echo site_url('C_dasboard_atasan'); ?>">Home</a>
                        </li>                  
                    </ul>                   
