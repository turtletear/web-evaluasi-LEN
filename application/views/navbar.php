        ...
        <div class="row">
            <div class="col-md-12">              
                <nav class="navbar navbar-dark navbar-expand-sm navbar-collapse" style="background-color: #185089;">
                    <a href="<?php echo site_url('C_dashboard_atasan'); ?>" class="navbar-brand" style="margin-right:-25%;">
                    ...
                    <div class="collapse navbar-collapse" id="collapsibleNavbar">                    
                        <ul class="navbar-nav ml-auto">                  
                            ...
                            <li class="nav-item">
                                <a class="nav-link" style="padding-right : 30px;" href="<?php echo site_url('C_history_atasan'); ?>">History</a>
                            </li>                  
                        </ul>                   
